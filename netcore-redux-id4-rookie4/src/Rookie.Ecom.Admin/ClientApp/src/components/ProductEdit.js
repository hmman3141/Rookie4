    ...
    render() {
        ...
        return (
            <div>
                ...
                {user ? renderProductEditTable(productedit, categories, productpicture, this.props, user) : <span>Please login!</span>}
            </div>
        );
    }
}
...
function renderProductEditTable(product, categories, productpicture, props, user) {
