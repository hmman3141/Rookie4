...
{
    public partial class Add_Order_OrderDetail_Rating_User_UserAddressAddFeature_Category_Product : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAddress", x => new { x.UserID, x.Number });
                    table.ForeignKey(
