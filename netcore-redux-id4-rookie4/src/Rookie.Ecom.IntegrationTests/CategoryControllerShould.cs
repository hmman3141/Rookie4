...
namespace Rookie.Ecom.IntegrationTests
{
    public class CategoryControllerShould : IClassFixture<SqliteInMemoryFixture>
    {
        ...
        public async Task Add_New_Category_Success()
        {
            ...
            var newCategory = new CategoryDto { CategoryName = "Test Category", Desc = "TC" };
        ...
        {
            // Arrange
            var existCategory = new Category { Id = Guid.NewGuid(), CategoryName = "Laptop", Desc = "LT" };
            await _categoryRepository.AddAsync(existCategory);

            var categoryService = new CategoryService(_categoryRepository, _mapper);
            var categoryController = new CategoryController(categoryService);

            var newCategory = new CategoryDto { CategoryName = "Laptop 2", Desc = "ABC" };
        ...
        {
            //Arrange
            var category1 = new Category { CategoryName = "Cate 1", Desc = "Code1" };
            var category2 = new Category { CategoryName = "Cate 2", Desc = "Code2" };
            var category3 = new Category { CategoryName = "Cate 3", Desc = "Code3" };
            var category4 = new Category { CategoryName = "Cate 4", Desc = "Code4" };
